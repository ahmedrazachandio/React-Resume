...
<div className="shedow">
    ...
    <div className="top-of-cv">
        ...
        <h1>Muhammad Saad</h1>
        <p>Cell # 0312-2522402</p>
        <p>muhammadsaad2522@gmail.com</p>
        <a href="https://www.linkedin.com/in/muhammad-saad25" target="blank">https://www.linkedin.com/in/muhammad-saad25</a><br/>
        <a href="https://github.com/MuhammadSaad25" target="blank">https://github.com/MuhammadSaad25</a>
    ...
    <div className="objective">
        ...
        <p>
            Objective is to take challenge of making website for companies. Providing good unique and professional designs for companies. Another role is to gain employment as a marketing associate where I can effectively utilize my skills as a marketing professional,
...
{/* <a href="../index.html"><button className="h-btn">Home</button></a> */}
</div>
